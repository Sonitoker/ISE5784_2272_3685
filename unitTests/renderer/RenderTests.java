...
//
//        scene.setAmbientLight(new AmbientLight(new Color(255, 255, 255).reduce(6), new Double3(0.15)));
//        scene.lights.add(new SpotLight(new Vector(1, 0, 0), new Color(RED), new Point(-300, 6, 10)));
//
//        double angle = 0;
//        double height = 0;
//
...
//
//        scene.lights.add(new SpotLight( new Vector(1, 0, 0),new Color(255, 255, 255).reduce(2), new Point(-150, 0, 5)));
//        scene.lights.add(new SpotLight(new Vector(1, 0, 0),new Color(GREEN).reduce(2), new Point(50, 0, 5)));
//
