...
public class LightsTests {
    ...
    private final Color sphereLightColor2 = new Color(200, 50, 255);
    /**
     * Color of the sphere
     */
    ...
    public void sphereSpot() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new SpotLight(sphereLightDirection, sphereLightColor, sphereLightPosition)
    ...
    public void trianglesSpot() {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new SpotLight(trianglesLightDirection, trianglesLightColor, trianglesLightPosition)
                .setKl(0.001).setKq(0.0001));
    ...
    public void sphereSpotSharp() {
        scene1.geometries.add(sphere);
        scene1.lights
                .add(new SpotLight(new Vector(1, 1, -0.5), sphereLightColor, sphereLightPosition)
    ...
    public void sphereAllLights() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new SpotLight( new Vector(0, 0, -1),new Color(green), new Point(20, 0, 50)).setKl(0.0001).setKq(0.000004));
        scene1.lights.add(new PointLight(new Color(red), new Point(100, 20, 5)).setKl(0.0001).setKq(0.000002));
        scene1.lights.add(new DirectionalLight( new Vector(1, -2, -1),new Color(white)));
    ...
    public void triangleAllLights() {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new SpotLight(new Vector(0,0,-1), new Color(blue), new Point(20,0,50))
                .setKl(0.0001).setKq(0.000002));
        scene2.lights.add(new PointLight(new Color(white), new Point(10,2,5)));
        scene2.lights.add(new DirectionalLight(new Vector(1,0,-1), new Color(red)));
